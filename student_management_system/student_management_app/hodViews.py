...
from student_management_app.models import CustomUser, Teachers,Class,Parents,Subjects_name,Specification
...
def add_subject_save(request):
    if request.method!="POST":
       ...
       try:
          subject=Subjects_name(subject_name=subject_name)
          subject.save()
...
def add_specification(request):
    ...
    subjects=Subjects_name.objects.all()
...
def add_specification_save(request):
    if request.method!="POST":
       ...
       try:
          ...
          subject_obj=Subjects_name.objects.get(id=subject_id)
...
def add_parent(request):
    ...
    return render(request,"hod_template/add_parent_template.html",{"classes":classes,"courses":courses}) 
